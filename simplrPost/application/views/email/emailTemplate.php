                                ...
                                <td class='movableContentContainer ' valign='top'>
                                  ...
                                  <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top: 20px;">
                                      <tr>
                                        <td valign='middle' align='center' style="height: 4px; background-color: #1bac71; width: 100%; margin-top: 5px;">
                                        </td>
                                      </tr>
                                    </table>
                                  </div>
                                  <div class="movableContent" style="border: 0px; padding-top: 0px; position: relative;">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                                     ...
                                     <tr>
                                      ...
                                      <tr>
                                        <td height='20' style="font-size: 14px; line-height:  2;">
                                         <!-- <span style="font-size:90%; line-height:14px;"><b> Confidentiality Notice:</b> This communication, including attachments, is for the exclusive use of the addressee and may contain proprietary, confidential or privileged information. If you are not the intended recipient, any use, copying, disclosure, dissemination, distribution is strictly prohibited. If you are not the intended recipient, please notify the sender immediately by return email and delete and destroy this communication and destroy all copies.</span> -->
                                        </td>
                                      </tr>
                                      <tr>
                                        <td height="20"></td>
                                      ...
                                      <tr align="left">
                                          ...
                                          <a href="https://www.facebook.com/urcommunitycaresinc/" target="_blank"> <img src="https://urcommunitycares.com/assets/images/facebook.png" width="30px"></a>
                                          </td>
                                      </tr> -->
                                    </table>
                                  </div>
                                                  ...
                                                  <td valign="top" class="specbundle">
                                                    <div class="contentEditableContainer contentTextEditable">
                                                      <div class="contentEditable" align='center'>
                                                        <p style="text-align: center;">Copyright © 2019, Simplr Post, Inc. All Rights Reserved. </p>
                                                      </div>
                                                    </div>
                                                  </td>
