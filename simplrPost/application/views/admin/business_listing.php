    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button type="button" class="btn btn-primary deleteModalButton" id="" onclick="deleteBusiness(this.id)">Delete</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="col">
      <div class="card shadow">
        <div class="card-header border-0">
          <h3 class="mb-0">Business Listing</h3>
          <div class="row">
            <div class="form-group col-lg-6 col-md-6 col-sm-12">
              <h4 class="pt-3">Filter</h4>
              <div class="row">
                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                  <label class="px-2 py-2">Date</label>
            ...
            <div class="form-group col-lg-6 col-md-6 col-sm-12">
              ...
              <div class="row">
                ...
                <div class="form-group col-lg-6 col-md-6 col-sm-12">
                  <label class="px-2 py-2">Name</label>
                  <div class="input-group input-group-alternative">
                    <select class="form-control" id="sortingByNameFilter">
                      <option value="">Select Sort Order</option>
          ...
          <div class="table-responsive" id="businessListing">
            <table class="table align-items-center table-flush" id="businessList">
              <thead class="thead-light">
                <tr>
                  ...
                  <th scope="col">Delete Business</th>
                </tr>
              </thead>
              <tbody>
      ...
      <script type="text/javascript">
        ...
        $('#sortingByNameFilter').change(function() {
          loadPagination(0);
        })
        ...
        // $arrAllCookies = $allCookies.split(';')[0];
        // $currentActivePage = $arrAllCookies.split('=')[1];
        // if($currentActivePage == undefined){
          loadPagination(0);
        // } else {
        //   loadPagination($currentActivePage);
        // }
        function loadPagination(pagno) {
          // document.cookie = "currentActivePage="+pagno+"; expires=10";
          $.ajax({
            url: '<?=SITE_URL?>Admin/Admin/loadBusinessListing/' + pagno,
            type: 'post',
            dataType: 'json',
            data: {
              'date' : $('#datepicker').val(),
              'sorting' : $('#sortingFilter').val(),
              'sortingByName' : $('#sortingByNameFilter').val(),
            ...
            success: function(data) {
              if(data.result == ''){
                ...
                if(pagno != 0){
                  $('html, body').animate(
                    {
                      scrollTop: $('#businessListing').offset().top,
                    },
                    200,
                    'linear'
                  )
        ...
        function createTable(result, sno) {
          ...
          $('#businessList tbody').empty();
          for (index in result) {
            $addressId = result[index].addressId;
        ...
        function setDeleteModalBusinessId(id) {
